      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <FractalButton asChild className="text-lg font-bold bg-[#9b56f7] text-white hover:bg-[#9b56f7]/90 rounded-full px-8 py-5 shadow-lg">
              <Link to="/book-consultation">Speak to an Expert</Link>
            </FractalButton>
            <FractalButton asChild className="text-lg font-bold bg-[#5cbce9] text-white hover:bg-[#5cbce9]/90 rounded-full px-8 py-5 shadow-lg">
