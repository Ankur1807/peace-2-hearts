...
const pastelClass = "bg-gradient-to-br from-white to-peacefulBlue/10 shadow-md"; // Match Therapy & Legal cards

const cardClasses =
  `${pastelClass} rounded-xl border border-gray-100 p-8 flex flex-col h-full transition-shadow duration-300 hover:shadow-lg`;

const iconWrapperClasses = "p-4 rounded-full bg-vibrantPurple/10 flex items-center justify-center mr-4";
const iconWrapperClassesAlt = "p-4 rounded-full bg-peacefulBlue/10 flex items-center justify-center mr-4";
  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-10"> {/* Increased gap for more breathing room */}
          ...
          <div className={cardClasses.replace("bg-vibrantPurple/10", "bg-peacefulBlue/10")}>
            <div className="mb-6 flex items-center">
              <div className={iconWrapperClassesAlt}>
