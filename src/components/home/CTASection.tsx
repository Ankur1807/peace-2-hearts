      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <FractalButton asChild fractalType="primary" pulseEffect={true} className="text-lg font-bold bg-white text-peacefulBlue hover:bg-white/90 rounded-full px-8 py-5">
              <Link to="/book-consultation">Get Support Now</Link>
            </FractalButton>
            <FractalButton asChild fractalType="outline" className="text-lg font-bold border-white text-white hover:bg-white/10 rounded-full px-8 py-5">
