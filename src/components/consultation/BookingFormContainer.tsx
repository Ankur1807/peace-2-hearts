  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-vibrantPurple/20 to-peacefulBlue/20">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 relative z-10">
        <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 relative">
          {/* Glassmorphism effects */}
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-md -z-10"></div>
