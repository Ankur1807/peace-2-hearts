        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="text-gray-600 hover:text-purple-600">Our Services</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services/mental-health" className="text-gray-600 hover:text-purple-600">Mental Health Support</Link></li>
              <li><Link to="/services/legal-support" className="text-gray-600 hover:text-purple-600">Legal Consultations</Link></li>
              <li><Link to="/services/therapy" className="text-gray-600 hover:text-purple-600">Relationship Therapy</Link></li>
              <li><Link to="/services/divorce" className="text-gray-600 hover:text-purple-600">Divorce Guidance</Link></li>
              <li><Link to="/services/custody" className="text-gray-600 hover:text-purple-600">Custody Support</Link></li>
            </ul>
          </div>
